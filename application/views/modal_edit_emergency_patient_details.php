<?php echo form_open('emergency_patients/update/' . $param2, array('id' => 'update_emergency_patient_details', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
<?php
...
?>
	...
	<div class="form-group">
		...
		<div class="col-md-12">
			<input readonly value="<?php echo html_escape($row['pid']); ?>" name="pid" type="text" value="<?php echo date('Ym'); ?>" data-parsley-required="true" class="form-control" placeholder="Type ID of the patient" />
		</div>
	</div>
	<div class="form-group">
...
<script>
	...
	$('#update_emergency_patient_details').parsley();
	FormPlugins.init();
</script>