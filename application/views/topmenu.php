...
<div id="top-menu" class="top-menu">
    ...
    <ul class="nav">
        ...
        <?php else : ?>
        <li class="has-sub <?php if ($page_name == 'appointments' || $page_name == 'patients' || $page_name == 'patient' || $page_name == 'prescriptions') echo 'active'; ?>">
            <a href="javascript:;">
                <b class="caret"></b>
            ...
            <ul class="sub-menu">
                ...
                <?php if (in_array($this->security->xss_clean($this->db->get_where('module', array('name' => 'patients'))->row()->module_id), $this->session->userdata('permissions'))) : ?>
                    <li class="<?php if ($page_name == 'patients' || $page_name == 'patient') echo 'active'; ?>">
        ...
        <?php endif; ?>
        <?php if (in_array($this->security->xss_clean($this->db->get_where('module', array('name' => 'tickets'))->row()->module_id), $this->session->userdata('permissions'))) : ?>
        ...
        <li class="menu-control menu-control-left">
            <a href="javascript:;" data-click="prev-menu"><i class="material-icons">arrow_back</i></a>
        </li>
        <li class="menu-control menu-control-right">
            <a href="javascript:;" data-click="next-menu"><i class="material-icons">arrow_forward</i></a>
        </li>
    </ul>
    <!-- end top-menu nav -->
</div>
