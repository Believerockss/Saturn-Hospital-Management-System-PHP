...
<div id="content" class="content">
	...
	<h1 class="page-header">
		<a onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_add_invoice');" href="javascript:;" class="btn btn-inverse m-r-5">
					...
					<table id="data-table-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							if ($this->session->userdata('user_type') == 'staff') {
								$invoices = $this->security->xss_clean($this->db->get('invoice')->result_array());
							} else {
								$invoices = $this->security->xss_clean($this->db->get_where('invoice', array('patient_id' => $this->session->userdata('user_id')))->result_array());
							}
									...
									<td>
										<div class="btn-group">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_invoice/<?php echo $row['invoice_id']; ?>');" href="javascript:;">Edit Invoice</a>
												<div class="dropdown-divider"></div>
												<a class="dropdown-item" onclick="confirm_modal('<?php echo base_url(); ?>invoices/delete/<?php echo $row['invoice_id']; ?>');" href="javascript:;">Remove</a>
											</div>
										</div>
									</td>
									<?php endif; ?>
