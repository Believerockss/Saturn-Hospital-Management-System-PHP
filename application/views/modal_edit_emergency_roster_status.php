<?php echo form_open('emergency_rosters/update_status/' . $param2, array('id' => 'update_emergency_roster_status', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
...
<script>
	...
	$('#update_emergency_roster_status').parsley();
	FormPlugins.init();
</script>