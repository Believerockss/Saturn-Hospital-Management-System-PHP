<?php echo form_open('shift_categories/create', array('id' => 'create_shift_category', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
