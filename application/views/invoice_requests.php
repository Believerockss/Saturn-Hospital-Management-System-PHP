					...
					<table id="data-table-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							if ($this->session->userdata('user_type') == 'staff') {
								$invoice_requests = $this->db->get('invoice_request')->result_array();
							} else {
								$invoice_requests = $this->db->get_where('invoice_request', array('patient_id' => $this->session->userdata('user_id')))->result_array();
							}
