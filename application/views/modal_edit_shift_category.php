<?php echo form_open('shift_categories/update/' . $param2, array('id' => 'update_shift_category', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
<?php
$staff_categories = $this->security->xss_clean($this->db->get_where('staff_category', array('staff_category_id' => $param2))->result_array());
...
?>
	...
	<div class="form-group">
		<label class="col-md-12 col-form-label">Payment Type *</label>
		<div class="col-md-12">
			<select style="width: 100%" class="form-control default-select2" data-parsley-required="true" name="payment_type">
				<option value="">Select payment type</option>
				<option value="1" disabled>Monthly</option>
				<option value="2" selected>Shiftwise</option>
			</select>
		</div>
	</div>
	<div class="form-group">
		<label class="col-md-12 col-form-label">Pay Scale</label>
		<div class="col-md-12">
