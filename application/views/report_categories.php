...
<div id="content" class="content">
	...
	<h1 class="page-header">
		<a onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_add_report_category');" href="javascript:;" class="btn btn-inverse m-r-5">
			<i class="fa fa-plus"></i> Add Report Category
		</a>
	</h1>
	<!-- end page-header -->
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<?php 
											if ($this->db->get_where('laboratory', array('laboratory_id' => $row['laboratory_id']))->num_rows() > 0)
												echo $this->security->xss_clean($this->db->get_where('laboratory', array('laboratory_id' => $row['laboratory_id']))->row()->name); 
											else
									...
									<td>
										<div class="btn-group">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_report_category_details/<?php echo $row['report_category_id']; ?>');" href="javascript:;">Edit Details</a>
												<div class="dropdown-divider"></div>
												<a class="dropdown-item" onclick="confirm_modal('<?php echo base_url(); ?>report_categories/delete/<?php echo $row['report_category_id']; ?>');" href="javascript:;">Remove</a>
											</div>
										</div>
									</td>
								</tr>
