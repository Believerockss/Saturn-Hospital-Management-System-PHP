<?php echo form_open('cafeteria_inventory/update/' . $param2, array('id' => 'update_cafeteria_inventory_details', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
<?php
$pharmacy_inventory = $this->security->xss_clean($this->db->get_where('cafeteria_inventory', array('cafeteria_inventory_id' => $param2))->result_array());
...
?>
	...
	<div class="form-group">
		<label class="col-md-12 col-form-label">Unit Price *</label>
		<div class="col-md-12">
...
<script>
	...
	$('#update_cafeteria_inventory_details').parsley();
	FormPlugins.init();
</script>