<?php echo form_open('cafeteria_sales/create', array('id' => 'create_cafeteria_sale', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
