<?php echo form_open('reports/create/0', array('id' => 'create_report_customer', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
...
<script>
	...
	$('#create_report_customer').parsley();
	FormPlugins.init();
