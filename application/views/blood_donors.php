...
<div id="content" class="content">
	...
	<h1 class="page-header">
		<a onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_add_blood_donor');" href="javascript:;" class="btn btn-inverse m-r-5">
				...
				<div class="panel-body">
					<table id="data-table-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							$blood_donors = $this->db->get('blood_donor')->result_array();
							...
							?>
								<tr>
									...
									<td>
										<?php
										if ($row['last_donated_on'] == 0)
											echo 'N/A';
										else
											echo date('d M, Y', $row['last_donated_on']);
										?>
									</td>
									<td>
										<?php
										if ($row['status'] == 0)
											echo '<span class="badge badge-warning">Collected</span>';
										else
											echo '<span class="badge badge-success">Donated</span>';
										?>
									</td>
									...
									<td>
										<div class="btn-group">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_view_blood_donor_details/<?php echo $row['blood_donor_id']; ?>');" href="javascript:;">Show Details</a>
												<a class="dropdown-item" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_blood_donor_details/<?php echo $row['blood_donor_id']; ?>');" href="javascript:;">Edit Details</a>
												<?php if ($row['status'] == 0) : ?>
													<div class="dropdown-divider"></div>
													<a class="dropdown-item" onclick="confirm_modal('<?php echo base_url(); ?>blood_donors/delete/<?php echo $row['blood_donor_id']; ?>');" href="javascript:;">Remove</a>
												<?php endif; ?>
											</div>
										</div>
									</td>
