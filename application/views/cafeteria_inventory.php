...
<div id="content" class="content">
	...
	<h1 class="page-header">
		<a onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_add_cafeteria_inventory');" href="javascript:;" class="btn btn-inverse m-r-5">
			<i class="fa fa-plus"></i> Add Cafeteria Inventory
		</a>
	</h1>
	<!-- end page-header -->
				...
				<div class="panel-body">
					<table id="data-table-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							$cafeteria_inventory = $this->security->xss_clean($this->db->get('cafeteria_inventory')->result_array());
							foreach ($cafeteria_inventory as $row) :
							?>
								<tr>
									...
									<td>
										<div class="btn-group">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_cafeteria_inventory_details/<?php echo $row['cafeteria_inventory_id']; ?>');" href="javascript:;">Edit Details</a>
												<div class="dropdown-divider"></div>
												<a class="dropdown-item" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_cafeteria_inventory/<?php echo $row['cafeteria_inventory_id']; ?>');" href="javascript:;">Edit Inventory</a>
											</div>
										</div>
									</td>
								</tr>
