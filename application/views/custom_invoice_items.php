...
<div id="content" class="content">
	...
	<h1 class="page-header">
		<a onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_add_custom_invoice_item');" href="javascript:;" class="btn btn-inverse m-r-5">
			<i class="fa fa-plus"></i> Add Custom Invoice Item
		</a>
	</h1>
	<!-- end page-header -->
				...
				<div class="panel-body">
					<table id="data-table-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							foreach ($custom_invoice_items as $row) :
							?>
								<tr>
									...
									<td>
										<div class="btn-group">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_custom_invoice_item/<?php echo $row['custom_invoice_item_id']; ?>');" href="javascript:;">Edit Custom Invoice Item</a>
												<div class="dropdown-divider"></div>
												<a class="dropdown-item" onclick="confirm_modal('<?php echo base_url(); ?>custom_invoice_items/delete/<?php echo $row['custom_invoice_item_id']; ?>');" href="javascript:;">Remove</a>
											</div>
										</div>
									</td>
								</tr>
