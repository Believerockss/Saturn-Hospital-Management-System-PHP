<?php echo form_open('blood_donors/create', array('id' => 'create_blood_donor', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
<div class="form-group">
	<label class="col-md-12 col-form-label">Name *</label>
	<div class="col-md-12">
		<input name="name" type="text" data-parsley-required="true" class="form-control" placeholder="Type name of the donor" />
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-12">
		<input name="mobile_number" type="text" data-parsley-required="true" class="form-control" placeholder="Type mobile number of the donor" />
	</div>
</div>
<div class="form-group">
	<label class="col-md-12 col-form-label">Email</label>
	<div class="col-md-12">
		<input name="email" type="email" class="form-control" placeholder="Type email of the donor" />
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-12">
		<input name="last_donated_on" id="datepicker-autoClose" type="text" class="form-control" placeholder="Choose last donated date or keep empty for N/A" />
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-12">
		<textarea name="purpose" data-parsley-required="true" class="form-control" placeholder="Type a brief description on the purpose for donation" rows="5"></textarea>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-12">
		<input name="dob" onkeyup="changeAge()" class="form-control" id="masked-input-date" placeholder="mm/dd/yyyy" type="text">
	</div>
</div>
<div class="form-group">
	<label class="col-md-12 col-form-label">Age *</label>
	<div class="col-md-12">
		<input name="age" id="age" onkeyup="changeBday()" data-parsley-type="number" data-parsley-min="0" data-parsley-required="true" class="form-control" placeholder="Type age of the donor" />
	</div>
</div>
<div class="form-group">
	<label class="col-md-12 col-form-label">Health Status *</label>
	<div class="col-md-12">
		<textarea name="health_status" data-parsley-required="true" class="form-control" placeholder="Type a little on the health status of the donor" rows="5"></textarea>
	</div>
</div>
