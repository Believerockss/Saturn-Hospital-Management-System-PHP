<?php echo form_open('shift_categories/update_permission/' . $param2, array('class' => 'form-horizontal', 'method' => 'post')); ?>
<?php
$permissions = $this->security->xss_clean($this->db->get_where('staff_category', array('staff_category_id' => $param2))->row()->permissions);
            ...
            ?>
                <div class="col-md-6">
                    <div class="checkbox checkbox-css">
                        ...
                        <label for="<?php echo $module['title']; ?>"><?php echo $module['title']; ?></label>
                    </div>
