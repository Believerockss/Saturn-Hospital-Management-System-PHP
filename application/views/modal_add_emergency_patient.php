<?php echo form_open('emergency_patients/create', array('id' => 'create_emergency_patient', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
...
<script>
	...
	$('#create_emergency_patient').parsley();
	FormPlugins.init();
</script>