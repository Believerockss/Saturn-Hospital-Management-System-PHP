<?php echo form_open('pharmacy_sales/edit/' . $param2, array('id' => 'update_pharmacy_sale', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
