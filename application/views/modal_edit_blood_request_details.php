...
?>
	...
	<div class="form-group">
		...
		<div class="col-md-12">
			<textarea name="purpose" data-parsley-required="true" class="form-control" placeholder="Type where, when and why do you need it" rows="5"><?php echo $row['purpose']; ?></textarea>
		</div>
	</div>
	<div class="form-group">
