...
<div id="content" class="content">
	...
	<h1 class="page-header">
		<a onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_add_caferetia_unit');" href="javascript:;" class="btn btn-inverse m-r-5">
			<i class="fa fa-plus"></i> Add Cafeteria Unit
		</a>
	</h1>
	<!-- end page-header -->
				...
				<div class="panel-body">
					<table id="data-table-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							$cafeteria_units = $this->security->xss_clean($this->db->get_where('unit', array('unit_for' => 2))->result_array());
							foreach ($cafeteria_units as $row) :
							?>
								<tr>
									...
									<td>
										<div class="btn-group">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_cafeteria_unit/<?php echo $row['unit_id']; ?>');" href="javascript:;">Edit Unit</a>
												<div class="dropdown-divider"></div>
												<a class="dropdown-item" onclick="confirm_modal('<?php echo base_url(); ?>cafeteria_units/delete/<?php echo $row['unit_id']; ?>');" href="javascript:;">Remove</a>
											</div>
										</div>
									</td>
								</tr>
