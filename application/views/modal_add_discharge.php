<?php echo form_open('discharges/create', array('id' => 'create_discharge', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
...
<div class="form-group">
	...
	<div class="col-md-12">
		<textarea name="conditions" data-parsley-required="true" class="form-control" placeholder="Type condition on discharge" rows="5"></textarea>
	</div>
</div>
<div class="form-group">
	<label class="col-md-12 col-form-label">Instructions</label>
	<div class="col-md-12">
		<textarea name="instructions" class="form-control" placeholder="Type discharge instructions" rows="5"></textarea>
	</div>
</div>
<div class="form-group">
