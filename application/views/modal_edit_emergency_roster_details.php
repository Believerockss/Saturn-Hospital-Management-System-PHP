<?php echo form_open('emergency_rosters/update/' . $param2, array('id' => 'update_emergency_roster_details', 'class' => 'form-horizontal', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
<?php
...
<script>
	...
	$('#update_emergency_roster_details').parsley();
	FormPlugins.init();
</script>