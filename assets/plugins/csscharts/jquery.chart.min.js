...
t!==a&&(i.find("#"+r.attr("id")).parent().remove(),i.find(".svg").append(s))}())}),i.on('mouseleave', function (t){n.find("."+a.attr("class")).remove()})}()},donut:function(a){var n=t(a),e=n.attr("data-percent"),r=n.attr("data-title")
